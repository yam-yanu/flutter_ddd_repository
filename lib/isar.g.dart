...
final _schema =
    '[{"name":"Product","idProperty":"id","properties":[{"name":"id","type":3},{"name":"name","type":5},{"name":"price","type":3}],"indexes":[],"links":[]},{"name":"Cart","idProperty":"productId","properties":[{"name":"productId","type":3},{"name":"quantity","type":3}],"indexes":[],"links":[]},{"name":"MVVMCart","idProperty":"productId","properties":[{"name":"productId","type":3},{"name":"quantity","type":3}],"indexes":[],"links":[]},{"name":"MVVMProduct","idProperty":"id","properties":[{"name":"id","type":3},{"name":"name","type":5},{"name":"price","type":3}],"indexes":[],"links":[]}]';
